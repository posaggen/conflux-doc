 ...
 * @param [preFixed=false] {boolean} - If the last parameter is true, the given message will NOT automatically be prefixed with "\x19Conflux Signed Message:\n" + message.length + message, and assumed to be already prefixed.
 *
 * @param signatureObject {object}
 * @param signatureObject.messageHash {string} The hash of the given message already prefixed with "\x19Conflux Signed Message:\n" + message.length + message.
