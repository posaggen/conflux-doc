 ...
 * @param [rawTx.value] {number|string|BN|BigNumber} - The value transferred for the transaction in wei, also the endowment if it’s a contract-creation transaction.
